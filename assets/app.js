...
const products=[
{id:'lion',name:'Lion of Judah Tee - Black',price:30,cat:'tshirts',img:'lion-judah-tee.png',color:['Black'],sizes},
{id:'king',name:'King of Kings Tee - Black',price:30,cat:'tshirts',img:'king-of-kings-tee.png',color:['Black'],sizes},
{id:'yahwehblack',name:'YAHWEH Tee - Black',price:20,cat:'tshirts',img:'yahweh-black.png',color:['Black'],sizes},
{id:'yahwehwhite',name:'YAHWEH Tee - White',price:20,cat:'tshirts',img:'yahweh-white.png',color:['White'],sizes},
{id:'novanitywhite',name:'No Vanity 33 Tee - White',price:25,cat:'tshirts',img:'no-vanity-white.png',color:['White'],sizes,wide:true},
{id:'hoodie',name:'Lion of Judah Hoodie - Black',price:50,cat:'hoodies',img:'lion-judah-hoodie.png',color:['Black'],sizes},
{id:'christ',name:'Christ Returns Tee - Black',price:30,cat:'tshirts',img:'christ-returns-tee.png',color:['Black'],sizes},
{id:'crossdisciple',name:'Cross & Discipleship Tee - Black',price:25,cat:'tshirts',img:'cross-discipleship.png',color:['Black'],sizes,wide:true},
{id:'prayer',name:'Prayer Cross Tee - Black',price:25,cat:'tshirts',img:'prayer-cross.png',color:['Black'],sizes,wide:true},
{id:'sg',name:'Crown 33 Sweatpants - Gray',price:45,cat:'sweatpants',img:'sweatpants-gray.png',color:['Gray'],sizes,tall:true},
{id:'sb',name:'Crown 33 Sweatpants - Black',price:45,cat:'sweatpants',img:'sweatpants-black.png',color:['Black'],sizes,tall:true},
{id:'st',name:'Crown 33 Sweatpants - Tan',price:45,cat:'sweatpants',img:'sweatpants-tan.png',color:['Tan'],sizes,tall:true},
{id:'shb',name:'Crown 33 Shorts - Black',price:30,cat:'shorts',img:'black-crown-shorts.png',color:['Black'],sizes},
{id:'shr',name:'Crown 33 Shorts - Red',price:30,cat:'shorts',img:'red-crown-shorts.png',color:['Red'],sizes},
{id:'shw',name:'Crown 33 Shorts - White',price:30,cat:'shorts',img:'white-crown-shorts.png',color:['White'],sizes},
